...
describe('TextInput', () => {
  it('calls onEnter when Enter is pressed', () => {
    const onEnter = vi.fn()
    const { getByRole } = render(<TextInput name="t" onChange={() => {}} onEnter={onEnter} type="text" value="" />)
  ...
  it('calls onEscape when Escape is pressed', () => {
    ...
    const { getByRole } = render(<TextInput name="t" onChange={() => {}} onEscape={onEscape} type="text" value="" />)

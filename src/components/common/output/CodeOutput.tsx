...
export const CodeOutput = ({ label, placeholder, value }: CodeOutputProps) => {
  return (
    <fieldset className="flex min-h-0 w-full grow flex-col gap-1">
      ...
      <pre
        className="min-h-0 grow overflow-auto rounded-lg border-2 border-gray-900 bg-gray-950 p-4 font-mono text-body-sm break-words whitespace-pre-wrap text-gray-200"

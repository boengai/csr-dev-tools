...
export const CommandPalette = () => {
  ...
  const { activeDescendantId, activeIndex, handleKeyDown, listRef, setActiveIndex } = useKeyboardListNav<ToolRegistryEntry>(
    filteredTools,
    {
      getOptionId: (tool) => `command-palette-option-${tool.key}`,
      initialIndex: 0,

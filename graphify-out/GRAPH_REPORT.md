...
## Corpus Check
- 632 files · ~256,374 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4113 nodes · 4520 edges · 688 communities (424 shown, 264 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 504 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e825e401`
...
## Communities (688 total, 264 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (45): getTypeKindLabel(), GraphqlParseOutput, KIND_STYLES, KindBadge(), TypeDetailPanel(), KindBadge(), CloseButton(), DIALECT_OPTIONS (+37 more)
...
Cohesion: 0.1
Nodes (19): dialog, editors, output, trigger, dialog, output, dialog, input (+11 more)
...
Cohesion: 0.1
Nodes (17): hashOutput, checkboxes, octalInput, symbolicInput, button2048, generateButton, privateKeyCm, publicKeyCm (+9 more)
...
Cohesion: 0.15
Nodes (13): isValidDocument(), Listener, documentToFlow(), doc, docWithOneTable(), { edges }, { nodes }, { nodes, edges } (+5 more)
...
Cohesion: 0.14
Nodes (13): detailPanel, editor, roleRef, cmContent, copyButtons, editor, expressionInput, resultsPanel (+5 more)
...
Cohesion: 0.29
Nodes (10): DBML_TYPE_MAP, DBML_TYPE_REVERSE, parseColumnLine(), parseConstraintBrackets(), parseDbml(), parseRefLine(), REL_SYMBOL, REL_SYMBOL_REVERSE (+2 more)
...
Cohesion: 0.22
Nodes (8): Behavior Contract, Behavior Contract, code:bash (git add benchmarks/), Steps, Task 2: csr-diff — Myers Diff Algorithm WASM Crate, Task 3: csr-color — 6 Color Space Conversion WASM Crate, Task 5: Phase 3 Benchmarks, WASM Phase 3 — Text Processing Implementation Plan
...
Cohesion: 0.29
Nodes (6): ConvertMode, EntityMode, HtmlEntityConvertMode, HtmlEntityInput, readSource(), sourceKey()
...
Cohesion: 0.33
Nodes (5): ConvertMode, JsonTomlConvertMode, readSource(), sourceKey(), TomlJsonInput
...
Cohesion: 0.33
Nodes (5): ConvertMode, JsonYamlConvertMode, JsonYamlInput, readSource(), sourceKey()

### Community 166 - "Community 166"
Cohesion: 0.33
Nodes (5): ConvertMode, EscapedJsonConvertMode, EscapedJsonInput, readSource(), sourceKey()
...
Cohesion: 0.33
Nodes (5): ConvertMode, HtmlMdConvertMode, HtmlMdInput, readSource(), sourceKey()

### Community 175 - "Community 175"
Cohesion: 0.33
Nodes (5): ConvertMode, JsonXmlConvertMode, readSource(), sourceKey(), XmlJsonInput
...
Cohesion: 0.33
Nodes (5): ConvertMode, JsonCsvConvertMode, JsonCsvInput, readSource(), sourceKey()
...
Cohesion: 0.5
Nodes (3): CSR Dev Tools — Domain Language, Tool, Tool computation pipeline
...
## Knowledge Gaps
- **2012 isolated node(s):** `toolRoutes`, `PreRenderRoute`, `dialog`, `input`, `editors` (+2007 more)
...
- **What is the exact relationship between `User-Agent parser (browser/os/engine/device)` and `User-Agent parser (browser/os/engine/device)`?**
  _Edge tagged AMBIGUOUS (relation: implements) - confidence is low._
- **Why does `useDebounceCallback()` connect `Community 13` to `Community 0`, `Community 263`, `Community 265`, `Community 266`, `Community 137`, `Community 268`, `Community 269`, `Community 270`, `Community 23`, `Community 162`, `Community 423`, `Community 424`, `Community 426`, `Community 427`, `Community 192`, `Community 64`, `Community 194`, `Community 193`, `Community 195`, `Community 78`, `Community 338`, `Community 339`, `Community 341`, `Community 342`, `Community 87`, `Community 345`, `Community 97`, `Community 228`, `Community 229`, `Community 114`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `useToolComputation()` connect `Community 13` to `Community 64`, `Community 97`, `Community 195`, `Community 137`, `Community 269`, `Community 270`, `Community 78`, `Community 113`, `Community 345`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `cnMerge()` connect `Community 0` to `Community 137`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
...
- **Are the 35 inferred relationships involving `useToolComputation()` (e.g. with `CertificateDecoder()` and `AesEncryptDecrypt()`) actually correct?**
  _`useToolComputation()` has 35 INFERRED edges - model-reasoned connections that need verification._
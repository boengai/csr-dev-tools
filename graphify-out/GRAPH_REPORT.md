...
## Corpus Check
- 636 files · ~256,930 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4258 nodes · 4740 edges · 699 communities (433 shown, 266 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 538 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `afcb4213`
...
## Communities (699 total, 266 thin omitted)
...
Cohesion: 0.14
Nodes (32): GraphqlSchemaViewer(), HtmlFormatter(), JavaScriptMinifier(), JsonSchemaValidator(), JsonToTypeScript(), MarkdownPreview(), EncodeContent(), ProtobufCodec() (+24 more)
...
Cohesion: 0.12
Nodes (21): applyDbmlNow(), regenerateDbmlFromDocument(), setDbmlText(), doc, { document, result }, next, withGarbage, withText (+13 more)
...
Cohesion: 0.13
Nodes (16): heightInput, ratioInput, widthInput, hashOutput, hexInput, picker, button2048, generateButton (+8 more)
...
Cohesion: 0.11
Nodes (14): checkboxes, octalInput, symbolicInput, firstSwatch, hexInput, picker, swatches, detailPanel (+6 more)
...
Cohesion: 0.13
Nodes (12): cmContent, copyButtons, editor, expressionInput, resultsPanel, decodeOutput, decodeSourceInput, downloadBtn (+4 more)
...
Cohesion: 0.18
Nodes (10): Action, ContentProps, DecodeContent(), DecodeInput, EncodeInput, FORMAT_OPTIONS, INITIAL_STATE, PersistedState (+2 more)
...
Cohesion: 0.18
Nodes (10): code:tsx (const handleReset = () => {), code:bash (git add src/components/feature/image/BackgroundRemover/index), Phase 4 — Conditional-reset edge cases, Playwright MCP verification protocol, Self-review, Spec reference, Task 18: BackgroundRemover migration, Task 19: Any other conditional-reset tools (+2 more)
...
Cohesion: 0.29
Nodes (7): code:ts (// src/diagram/projections.spec.ts), code:ts (// src/diagram/projections.ts), code:bash (git add src/diagram/projections.ts src/diagram/projections.s), code:bash (git add -A), Phase 1 — Build the editor (no UI change), Task 12: Verify the editor module compiles and full test suite passes, Task 4: Projections — document → ReactFlow nodes/edges
...
## Knowledge Gaps
- **2095 isolated node(s):** `toolRoutes`, `PreRenderRoute`, `dialog`, `input`, `editors` (+2090 more)
...
- **What is the exact relationship between `User-Agent parser (browser/os/engine/device)` and `User-Agent parser (browser/os/engine/device)`?**
  _Edge tagged AMBIGUOUS (relation: implements) - confidence is low._
- **Why does `useToolComputation()` connect `Community 14` to `Community 129`, `Community 294`, `Community 297`, `Community 109`, `Community 78`, `Community 77`, `Community 18`, `Community 214`, `Community 25`, `Community 26`, `Community 382`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `useDebounceCallback()` connect `Community 14` to `Community 128`, `Community 1`, `Community 18`, `Community 25`, `Community 28`, `Community 289`, `Community 290`, `Community 291`, `Community 292`, `Community 293`, `Community 294`, `Community 297`, `Community 298`, `Community 180`, `Community 77`, `Community 211`, `Community 212`, `Community 213`, `Community 214`, `Community 89`, `Community 486`, `Community 487`, `Community 109`, `Community 246`, `Community 247`, `Community 376`, `Community 377`, `Community 379`, `Community 380`, `Community 382`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `ImageToolShell()` connect `Community 26` to `Community 14`, `Community 79`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._

...
## Corpus Check
- 625 files · ~254,965 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4144 nodes · 4567 edges · 695 communities (428 shown, 267 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 520 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `11ad187d`
...
## Communities (695 total, 267 thin omitted)
...
Cohesion: 0.14
Nodes (31): GraphqlSchemaViewer(), HtmlFormatter(), JsonSchemaValidator(), JsonToTypeScript(), MarkdownPreview(), DecodeContent(), EncodeContent(), ProtobufCodec() (+23 more)
...
Cohesion: 0.1
Nodes (18): dialog, output, dialog, input, secretInput, textInput, input, output (+10 more)

### Community 26 - "Community 26"
Cohesion: 0.14
Nodes (16): isValidDocument(), Listener, cloneDocument(), createInitialDocument(), a, b, doc, newDiagram() (+8 more)
...
Cohesion: 0.16
Nodes (14): applyDbmlNow(), regenerateDbmlFromDocument(), setDbmlText(), doc, { document, result }, next, withGarbage, withText (+6 more)
...
Cohesion: 0.13
Nodes (15): code:ts (// src/types/diagram/document.ts), code:ts (export * from './diagram/document'), code:bash (git add src/types/diagram/document.ts src/types/index.ts), code:ts (// src/diagram/state.spec.ts), code:ts (// src/diagram/state.ts), code:bash (git add -A), code:bash (git add src/diagram/state.ts src/diagram/state.spec.ts), code:ts (// src/diagram/editor.spec.ts) (+7 more)
...
Cohesion: 0.24
Nodes (12): DBML_TYPE_MAP, DBML_TYPE_REVERSE, formatConstraints(), generateDbml(), parseColumnLine(), parseConstraintBrackets(), parseDbml(), parseRefLine() (+4 more)
...
Cohesion: 0.21
Nodes (10): JSON_TYPE_MAP, mapJsonType(), parseJsonSchema(), resolveRefName(), authorCol, idCol, postTable, result (+2 more)
...
Cohesion: 0.2
Nodes (9): code:bash (git commit --allow-empty -m "chore: verify Phase 2 WASM buil), code:bash (git add package.json pnpm-lock.yaml), code:typescript (import { bench, describe } from 'vitest'), code:bash (git add benchmarks/phase2.bench.ts), Phase 2 — WASM Crypto Migration Implementation Plan, Task 11: Remove bcryptjs dependency, Task 12: Phase 2 benchmarks, Task 13: Final verification (+1 more)
...
Cohesion: 0.22
Nodes (6): Action, JavaScriptMinifier(), JsInput, JsMinifierAction, JsMinifierState, State
...
Cohesion: 0.22
Nodes (8): Behavior Contract, Behavior Contract, code:bash (git add benchmarks/), Steps, Task 1: csr-csv — CSV Parse/Stringify WASM Crate, Task 3: csr-color — 6 Color Space Conversion WASM Crate, Task 5: Phase 3 Benchmarks, WASM Phase 3 — Text Processing Implementation Plan
...
## Knowledge Gaps
- **2029 isolated node(s):** `toolRoutes`, `PreRenderRoute`, `dialog`, `input`, `editors` (+2024 more)
...
- **What is the exact relationship between `User-Agent parser (browser/os/engine/device)` and `User-Agent parser (browser/os/engine/device)`?**
  _Edge tagged AMBIGUOUS (relation: implements) - confidence is low._
- **Why does `useDebounceCallback()` connect `Community 13` to `Community 1`, `Community 274`, `Community 275`, `Community 276`, `Community 278`, `Community 279`, `Community 280`, `Community 24`, `Community 156`, `Community 171`, `Community 429`, `Community 430`, `Community 431`, `Community 432`, `Community 61`, `Community 199`, `Community 200`, `Community 201`, `Community 202`, `Community 77`, `Community 86`, `Community 346`, `Community 347`, `Community 348`, `Community 350`, `Community 352`, `Community 98`, `Community 237`, `Community 238`, `Community 119`, `Community 120`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `cnMerge()` connect `Community 80` to `Community 1`, `Community 107`, `Community 156`?**

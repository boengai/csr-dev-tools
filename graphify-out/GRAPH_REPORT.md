# Graph Report - csr-dev-tools  (2026-05-17)

## Corpus Check
- 705 files · ~289,179 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4945 nodes · 5585 edges · 755 communities (496 shown, 259 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 630 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `de512561`
- Run `git rev-parse HEAD` and compare to check if the graph is stale.
- Run `graphify update .` after code changes (no API cost).

## Community Hubs (Navigation)
- [[_COMMUNITY_Tool Components|Tool Components]]
- [[_COMMUNITY_DB Diagram Editor|DB Diagram Editor]]
- [[_COMMUNITY_Crypto & Cert Tools|Crypto & Cert Tools]]
- [[_COMMUNITY_Docs & UI Generators|Docs & UI Generators]]
- [[_COMMUNITY_E2E Test Suite|E2E Test Suite]]
- [[_COMMUNITY_CSR Formatter Plan|CSR Formatter Plan]]
- [[_COMMUNITY_QR  Markdown Plan|QR / Markdown Plan]]
- [[_COMMUNITY_Blob URL Lifecycle|Blob URL Lifecycle]]
- [[_COMMUNITY_WASM Migration Design|WASM Migration Design]]
- [[_COMMUNITY_Diagram Editor Core|Diagram Editor Core]]
- [[_COMMUNITY_Contributing Guide|Contributing Guide]]
- [[_COMMUNITY_WASM Facades|WASM Facades]]
- [[_COMMUNITY_Package Dependencies|Package Dependencies]]
- [[_COMMUNITY_JSON  CSV Converter|JSON / CSV Converter]]
- [[_COMMUNITY_QRMarkdown Design|QR/Markdown Design]]
- [[_COMMUNITY_Code Tool Family|Code Tool Family]]
- [[_COMMUNITY_Common Button API|Common Button API]]
- [[_COMMUNITY_Formatter Family|Formatter Family]]
- [[_COMMUNITY_Protobuf Codec Plan|Protobuf Codec Plan]]
- [[_COMMUNITY_App Shell & Buttons|App Shell & Buttons]]
- [[_COMMUNITY_Development Guide|Development Guide]]
- [[_COMMUNITY_Tool Dialog Shell|Tool Dialog Shell]]
- [[_COMMUNITY_Timezone Converter|Timezone Converter]]
- [[_COMMUNITY_Image Tool Shell|Image Tool Shell]]
- [[_COMMUNITY_DB Diagram Columns|DB Diagram Columns]]
- [[_COMMUNITY_Crontab Parser|Crontab Parser]]
- [[_COMMUNITY_OG Tags  Strings|OG Tags / Strings]]
- [[_COMMUNITY_Diagram Concepts|Diagram Concepts]]
- [[_COMMUNITY_E2E Code Tools|E2E Code Tools]]
- [[_COMMUNITY_IP Subnet Calculator|IP Subnet Calculator]]
...
2. `useToolComputation()` - 63 edges
3. `DiagramEditor` - 44 edges
4. `dependencies` - 38 edges
5. `createInitialDocument()` - 26 edges
6. `useMountOnce()` - 24 edges
7. `utils barrel index` - 24 edges
8. `useToolFields()` - 23 edges
9. `useStaleSafeAsync()` - 22 edges
10. `compilerOptions` - 20 edges

## Surprising Connections (you probably didn't know these)
- `ToolRegistryKey` --references--> `Component Inventory`  [INFERRED]
  src/types/constants/tool-registry.ts → docs/component-inventory.md
- `Playwright E2E Config` --semantically_similar_to--> `Vitest Unit Test Config`  [INFERRED] [semantically similar]
  playwright.config.ts → vitest.config.ts
- `Vite Build Config` --references--> `SPA index.html Entry`  [INFERRED]
  vite.config.ts → index.html
- `CONTRIBUTING Guide` --semantically_similar_to--> `Development Guide`  [INFERRED] [semantically similar]
...
## Communities (755 total, 259 thin omitted)
...
Cohesion: 0.07
Nodes (36): CloseButton(), DIALECT_OPTIONS, DbmlEditorPanel(), DiagramCanvas(), edgeTypes, nodeTypes, ContextValue, Ctx (+28 more)

### Community 2 - "Crypto & Cert Tools"
Cohesion: 0.05
...
### Community 3 - "Docs & UI Generators"
Cohesion: 0.05
...
### Community 5 - "CSR Formatter Plan"
Cohesion: 0.04
...
### Community 7 - "Blob URL Lifecycle"
Cohesion: 0.05
...
### Community 8 - "WASM Migration Design"
Cohesion: 0.05
...
### Community 10 - "Contributing Guide"
Cohesion: 0.05
...
Cohesion: 0.05
Nodes (38): dependencies, ajv, @codemirror/lang-json, @codemirror/lang-sql, @codemirror/state, @codemirror/view, dompurify, graphql (+30 more)

### Community 13 - "JSON / CSV Converter"
Cohesion: 0.07
Nodes (25): compute(), ConvertMode, JsonCsvConvertMode, JsonCsvInput, MODES, readSource(), sourceKey(), compute() (+17 more)

### Community 14 - "QR/Markdown Design"
Cohesion: 0.06
...
Cohesion: 0.1
Nodes (41): CssFormatter(), JavaScriptMinifier(), MarkdownPreview(), ProtobufCodec(), SqlFormatter(), ColorConvertor(), BidirectionalConverter(), EnvFileConverter() (+33 more)
...
### Community 18 - "Protobuf Codec Plan"
Cohesion: 0.06
...
### Community 19 - "App Shell & Buttons"
Cohesion: 0.11
...
### Community 20 - "Development Guide"
Cohesion: 0.07
...
### Community 21 - "Tool Dialog Shell"
Cohesion: 0.09
Nodes (20): contentVariants, Dialog(), calls, { container }, decryptOpen, encryptOpen, onAfterClose, onOpen (+12 more)

### Community 22 - "Timezone Converter"
Cohesion: 0.17
Nodes (13): ConverterInput, ConverterOutput, createInitialConverterState(), DEFAULT_TARGETS, favoriteButtonStyles, formatNowDate(), formatNowTime(), getInitialTargets() (+5 more)

### Community 23 - "Image Tool Shell"
Cohesion: 0.08
Nodes (20): FormatterShell(), a, anchorClicks, captured, { container }, el, getDownloadFilename, lastCall (+12 more)

### Community 24 - "DB Diagram Columns"
Cohesion: 0.16
Nodes (14): addColumn(), colIdSeq, deleteColumn(), a, { doc }, { doc: initial, tableId: aId }, { doc, tableId }, docAfterB (+6 more)

### Community 25 - "Crontab Parser"
Cohesion: 0.12
Nodes (20): CRON_PRESETS, describeCron(), describeField(), FIELDS, getNextRuns(), parseCron(), parseField(), result (+12 more)

### Community 26 - "OG Tags / Strings"
Cohesion: 0.12
Nodes (21): generateOgMetaTags(), OgConfig, fullConfig, lines, result, escapeHtml(), escapeJavaScript(), escapeJson() (+13 more)

### Community 27 - "Diagram Concepts"
Cohesion: 0.14
...
### Community 28 - "E2E Code Tools"
Cohesion: 0.1
Nodes (18): dialog, editors, output, trigger, dialog, output, input, output (+10 more)

### Community 29 - "IP Subnet Calculator"
Cohesion: 0.17
...
Cohesion: 0.25
Nodes (6): compute, errorSpy, onError, resolvers, { result }, { result, unmount }

### Community 33 - "Community 33"
Cohesion: 0.13
Nodes (17): canvasToBlob(), FAVICON_SIZES, generateFaviconLinkTags(), generateFavicons(), resizeToCanvas(), appleIcon, clickSpy, dimensions (+9 more)
...
Cohesion: 0.09
Nodes (21): completed_steps, current_step, findings, components, existing_docs, project_classification, technology_stack, testing (+13 more)
...
Cohesion: 0.15
Nodes (15): hashOutput, checkboxes, octalInput, symbolicInput, detailPanel, editor, roleRef, button2048 (+7 more)
...
Cohesion: 0.11
Nodes (16): BidirectionalConverter → useToolFields Migration Plan, code:bash (git add graphify-out/), code:tsx (it('writes to per-mode localStorage when typing in the sourc), code:tsx (it('clears source and fires compute with empty source when r), code:tsx (describe('BidirectionalConverter — mode persistence', () => ), code:bash (git add src/components/common/converter/BidirectionalConvert), code:tsx (import { useEffect, useRef, useState } from 'react'), code:tsx (import { useMemo, useState } from 'react') (+8 more)
...
Cohesion: 0.29
Nodes (6): ADR 0006 — CSS Playground family stays unshelled, code:tsx (<div className="flex w-full grow flex-col gap-4">), Consequences, Context, Decision, Revisit when
...
Cohesion: 0.29
Nodes (14): convertColor(), hexToHsl(), normalizeHue(), clampLightness(), createLightnessVariant(), createPaletteColor(), generateAnalogousPalette(), generateComplementaryPalette() (+6 more)
...
Cohesion: 0.12
Nodes (12): decimalInput, dialog, hexInput, output, dialog, output, dialog, output (+4 more)
...
Cohesion: 0.12
Nodes (16): devDependencies, jsdom, oxfmt, oxlint, @playwright/test, @tailwindcss/vite, @testing-library/jest-dom, @testing-library/react (+8 more)

### Community 61 - "Community 61"
Cohesion: 0.17
Nodes (10): Action, CompressInput, ImageCompressor(), ImageCompressorAction, ImageCompressorState, INITIAL_INPUT, initialState, OriginalInfo (+2 more)
...
Cohesion: 0.16
Nodes (14): applyDbmlNow(), DBML_TYPE_MAP, DBML_TYPE_REVERSE, formatConstraints(), generateDbml(), parseColumnLine(), parseConstraintBrackets(), parseDbml() (+6 more)

### Community 64 - "Community 64"
Cohesion: 0.15
Nodes (15): seed(), COLUMN_TYPES, createDefaultColumn(), createDefaultTable(), gridLayoutPositions(), col, col1, col2 (+7 more)
...
Cohesion: 0.12
Nodes (16): scripts, build, dev, format, format:check, lint, lint:fix, preview (+8 more)
...
Cohesion: 0.14
Nodes (14): Code, Color, CSS, Data, Encoding, Features, Generator, Image (+6 more)
...
Cohesion: 0.14
Nodes (7): DataUriGenerator(), initialState, Base64ToImage(), FILE_EXTENSIONS, formatFileSize(), parseFileName(), result
...
Cohesion: 0.08
Nodes (21): getTypeKindLabel(), GraphqlParseOutput, KIND_STYLES, KindBadge(), TypeDetailPanel(), KindBadge(), SelectInput(), TextAreaInput() (+13 more)
...
Cohesion: 0.12
Nodes (15): Code Formatters → useToolFields Cluster Migration Plan, code:tsx (// Before), code:tsx (// Before (CssFormatter / SqlFormatter shape)), code:tsx (// Before (every Tool, repeated for every field)), code:bash (git add src/components/feature/code/CssFormatter.tsx), code:bash (git add src/components/feature/code/JavaScriptMinifier.tsx s), code:bash (git add src/components/feature/code/SqlFormatter.tsx), code:bash (git add graphify-out/) (+7 more)
...
Cohesion: 0.12
Nodes (11): chevronStyles, computeMermaid(), INITIAL_RESULT, initialState, SYNTAX_EXAMPLES, DIAGRAM_TYPE_CORRECTIONS, MERMAID_FIX_RULES, suggestMermaidFix() (+3 more)
...
Cohesion: 0.18
Nodes (10): compute, Mode, MODES, onAfterDialogClose, onError, slot, { unmount }, readSource() (+2 more)

### Community 94 - "Community 94"
Cohesion: 0.11
Nodes (18): Async action, Batch asset pipeline, Bidirectional converter, CSR Dev Tools — Domain Language, DiagramEditor, Diff checker shell, Formatter shell, Image tool shell (+10 more)
...
Cohesion: 0.07
Nodes (26): code:tsx (export type UseToolFieldsPersistedOptions<F, R> = UseToolFie), code:tsx (import { useToolFieldsPersisted } from '@/hooks'), code:tsx (export const JsonSchemaValidator = ({ autoOpen, onAfterDialo), code:tsx (export const JsonSchemaValidator = ({ autoOpen, onAfterDialo), code:tsx (onClick={() => {), code:tsx (onClick={() => {), code:bash (git add src/components/feature/code/JsonSchemaValidator.tsx), code:markdown (## Persistent tool field bag) (+18 more)
...
Cohesion: 0.18
Nodes (10): engines, node, name, packageManager, peerDependencies, tailwind-merge, private, sideEffects (+2 more)
...
Cohesion: 0.12
Nodes (16): CopyButton(), copyButtonVariants, classes, iconOnly, labeled, propsWithLabel, propsWithVariant, validProps (+8 more)

### Community 107 - "Community 107"
Cohesion: 0.22
Nodes (8): code:ts (const recompute = () => {), code:bash (git add src/components/common/converter/BidirectionalConvert), code:bash (git status), Files, `recompute()` Pipeline Primitive Implementation Plan, Self-review checklist (already applied), Task 12: Final verification, Task 6: Migrate `<BidirectionalConverter>` to pipeline-owned `recompute`
...
Cohesion: 0.18
Nodes (9): Action, EMPTY_RESULT, INITIAL_INPUT, initialState, QrCodeAction, QrCodeState, QrInput, QrResult (+1 more)
...
Cohesion: 0.15
Nodes (12): code:tsx (import { useInputLocalStorage, useMountOnce, useToast, useTo), code:tsx (import { useMountOnce, useToast, useToolFieldsPersisted } fr), code:tsx (export const JsonpathEvaluator = (_props: ToolComponentProps), code:tsx (export const JsonpathEvaluator = (_props: ToolComponentProps), code:bash (git add src/components/feature/code/JsonpathEvaluator.tsx), code:bash (git add graphify-out/), Files, JsonpathEvaluator → useToolFieldsPersisted Migration Plan (+4 more)
...
Cohesion: 0.2
Nodes (9): copyButtons, dateInput, removeButtons, results, searchInputs, starButtons, stored, targetResults (+1 more)

### Community 119 - "Community 119"
Cohesion: 0.2
Nodes (9): compilerOptions, baseUrl, module, moduleResolution, paths, strict, target, include (+1 more)
...
Cohesion: 0.2
Nodes (10): calculateSubnet, ipToBinary, ipToNumber, maskToPrefix, numberToIp, parseCidr, prefixToMask, validateIpv4 (+2 more)

### Community 122 - "Community 122"
Cohesion: 0.2
Nodes (10): code:ts (export const generateUuid = async (): Promise<string> => {), code:tsx (const [uuids, setUuids] = useState(() => [generateUuid()])), code:tsx (const [uuids, setUuids] = useState<Array<string>>([])), code:tsx (const handleGenerate = async () => {), code:ts (it('should return a valid UUID v4 format', () => {), code:ts (it('should return a valid UUID v4 format', async () => {), code:ts (it('should generate 1 UUID when count is 1', async () => {), code:bash (pnpm test -- --reporter verbose src/utils/uuid.spec.ts) (+2 more)

### Community 123 - "Community 123"
Cohesion: 0.2
Nodes (9): code:bash (git commit --allow-empty -m "chore: verify Phase 2 WASM buil), code:typescript (import { describe, expect, it } from 'vitest'), code:bash (git add src/utils/bcrypt-hasher.spec.ts), code:bash (git add package.json pnpm-lock.yaml), Phase 2 — WASM Crypto Migration Implementation Plan, Task 10: Update tests, Task 11: Remove bcryptjs dependency, Task 13: Final verification (+1 more)

### Community 124 - "Community 124"
Cohesion: 0.2
Nodes (10): code:typescript (import {), code:typescript (import {), code:typescript (import {), code:typescript (import {), code:typescript (import type { JsonToTsOptions } from '@/types/utils/json-to-), code:typescript (import {), code:typescript (import type { ProtobufEnumInfo, ProtobufMessageInfo, Protobu), code:typescript (import type { CodecResult, OutputFormat } from '@/types/util) (+2 more)

### Community 125 - "Community 125"
Cohesion: 0.2
Nodes (9): code:typescript (import type {), code:typescript (import type { JsonToTsOptions } from '@/types/utils/json-to-), code:bash (git add src/wasm/csr-parsers.ts src/wasm/csr-json-tools.ts), code:bash (git add -A), code:bash (git add package.json pnpm-lock.yaml), Phase 4: Parsers — WASM Migration Implementation Plan, Task 10: Remove replaced JS dependencies, Task 7: Build WASM and create TypeScript wrappers (+1 more)

### Community 126 - "Community 126"
Cohesion: 0.2
Nodes (10): code:tsx (<ToolDialogShell), code:bash (git add src/components/feature/security/AesEncryptDecrypt.ts), code:tsx (<ToolDialogShell), code:bash (git add <path>), code:bash (git add src/components/feature/code/MermaidRenderer.tsx), Phase 3 — Pattern-B tools, Task 14: AesEncryptDecrypt migration, Task 15: QrCodeGenerator migration (+2 more)

### Community 127 - "Community 127"
Cohesion: 0.33
Nodes (5): ADR 0003 — Tool handoff stays as a typed seam at one adapter, Consequences, Context, Decision, Revisit when

### Community 128 - "Community 128"
Cohesion: 0.22
Nodes (8): ConvertMode, ENTITY_MODE_OPTIONS, EntityMode, HtmlEntityConvertMode, HtmlEntityInput, MODES, readSource(), sourceKey()
...
Cohesion: 0.2
Nodes (9): banner, card, defaultOptions, fontSize, hero, labels, match, svg (+1 more)
...
Cohesion: 0.25
Nodes (9): buildPreviewUri(), autoSizeFont(), downloadBlob(), downloadSvg(), escapeXml(), estimateSvgFontSize(), generatePlaceholderCanvas(), generatePlaceholderSvg() (+1 more)
...
Cohesion: 0.29
Nodes (6): ADR 0002 — ImageConvertor workflow stays inlined, Consequences, Context, Decision, Revisit when, Scope
...
Cohesion: 0.22
Nodes (9): code:toml (# wasm/crates/csr-diff/Cargo.toml), code:rust (// wasm/crates/csr-diff/src/types.rs), code:rust (// wasm/crates/csr-diff/src/myers.rs), code:rust (// wasm/crates/csr-diff/src/lib.rs), code:toml (# wasm/crates/csr-diff/Cargo.toml), code:typescript (// src/wasm/csr-diff.ts), code:typescript (// src/utils/diff.ts), code:bash (git add wasm/crates/csr-diff/ src/wasm/csr-diff.ts src/utils) (+1 more)

### Community 147 - "Community 147"
Cohesion: 0.22
Nodes (8): Behavior Contract, Behavior Contract, code:bash (git add package.json pnpm-lock.yaml), Steps, Task 2: csr-diff — Myers Diff Algorithm WASM Crate, Task 3: csr-color — 6 Color Space Conversion WASM Crate, Task 4: Integration — Build, Full Test Suite, Remove `diff` Dependency, WASM Phase 3 — Text Processing Implementation Plan
...
Cohesion: 0.33
Nodes (5): ADR 0008 — PlaceholderImageGenerator's reducer stays, Consequences, Context, Decision, Revisit when

### Community 152 - "Community 152"
Cohesion: 0.07
Nodes (27): code:block1 (useToolComputation              — single Input, narrow primi), code:tsx (import { useInputLocalStorage, useMountOnce, useToast, useTo), code:tsx (import { useToast, useToolComputationPersisted } from '@/hoo), code:tsx (export const ProtobufToJson = (_props: ToolComponentProps) =), code:tsx (export const ProtobufToJson = (_props: ToolComponentProps) =), code:tsx (const handleLoadExample = useCallback(() => {), code:tsx (const handleLoadExample = useCallback(() => {), code:bash (git add src/components/feature/code/ProtobufToJson.tsx) (+19 more)

### Community 153 - "Community 153"
Cohesion: 0.33
Nodes (5): ADR 0004 — Tool compute lives in `src/utils/<name>.ts` next to a `.spec.ts`, Consequences, Context, Decision, Revisit when
...
Cohesion: 0.26
Nodes (10): blob, clickSpy, filePaths, setHrefSpy, downloadBlob(), downloadBlobsAsZip(), downloadDataUrl(), triggerDownload() (+2 more)
...
Cohesion: 0.19
Nodes (10): event, handler, { rerender }, { unmount }, v1, v2, useKeyboardShortcut(), useKeyboardShortcuts() (+2 more)

### Community 173 - "Community 173"
Cohesion: 0.11
Nodes (21): isValidDocument(), cloneDocument(), createInitialDocument(), a, b, doc, importFromJsonSchema(), importFromSql() (+13 more)

### Community 175 - "Community 175"
Cohesion: 0.29
Nodes (5): fn, fn1, fn2, { rerender }, { unmount }
...
Cohesion: 0.22
Nodes (6): Action, INITIAL, JsInput, JsMinifierAction, JsMinifierState, State
...
Cohesion: 0.38
Nodes (5): initialState, PlaceholderImageGenerator(), PRESET_OPTIONS, reducer(), toPickerHex()
...
Cohesion: 0.33
Nodes (6): code:ts (// Re-fires compute with the current bag (preserves pre-migr), code:ts (// Re-fires compute with the current bag (preserves pre-migr), code:ts (if (jsonData.trim() && jsonSchema.trim()) {), code:ts (if (jsonData.trim() && jsonSchema.trim()) {), code:bash (git add src/components/feature/code/JsonSchemaValidator.tsx), Task 9: Migrate `JsonSchemaValidator` revalidate/validate sites to `recompute()`
...
Cohesion: 0.29
Nodes (6): DiffCell(), DiffInput, DiffResult, EMPTY_DIFF, INITIAL_RESULT, renderSpans()
...
Cohesion: 0.33
Nodes (5): ADR 0001 — Tool computation pipeline does not carry progress, Consequences, Context, Decision, Revisit when

### Community 217 - "Community 217"
Cohesion: 0.25
Nodes (7): Adding a new tool, AES blob format, Common component API rule, Common hook patterns, graphify, Typecheck command, Verifying UI changes
...
Cohesion: 0.33
Nodes (6): code:ts (// src/diagram/operations/relations.spec.ts), code:ts (// src/diagram/operations/relations.ts), code:ts (import * as relationOps from './operations/relations'), code:ts (addRelation(input: { from: ColumnRef; to: ColumnRef; kind: R), code:bash (git add src/diagram/operations/relations.ts src/diagram/oper), Task 7: Relation operations
...
Cohesion: 0.15
Nodes (8): descTags, existingDesc, ogUrl, preExisting, { rerender }, { unmount }, useToolSeo(), ToolsPageContent()
...
Cohesion: 0.33
Nodes (5): Action, MermaidComputeResult, MermaidRendererAction, MermaidRendererState, State
...
Cohesion: 0.33
Nodes (5): BatchAssetProcess, BatchAssetProgress, BatchAssetProgressReport, UseBatchAssetPipelineOptions, UseBatchAssetPipelineResult
...
Cohesion: 0.24
Nodes (5): useBatchAssetPipeline(), FaviconGenerator(), linkTags, id, useToast
...
Cohesion: 0.21
Nodes (7): computeConversion(), buildTimezoneIndex(), convertTimezone(), getAbbreviation(), getOffset(), getTimezoneList(), parseDateTimeInput()
...
Cohesion: 0.4
Nodes (3): AesInput, INITIAL_INPUT, Mode

### Community 278 - "Community 278"
Cohesion: 0.33
Nodes (6): AspectRatioCalculator(), Fields, INITIAL_FIELDS, lockIndicatorStyles, presetButtonStyles, PRESETS
...
Cohesion: 0.25
Nodes (7): UseToolComputationOptions, UseToolComputationPersistedOptions, UseToolComputationPersistedResult, UseToolComputationResult, UseToolFieldsOptions, UseToolFieldsPersistedOptions, UseToolFieldsResult
...
Cohesion: 0.6
Nodes (5): calculateDimension(), gcd(), parseRatio(), simplifyRatio(), solveAspectRatio()
...
Cohesion: 0.5
Nodes (3): editor, outputPanel, preElement
...
Cohesion: 0.5
Nodes (4): pnpm, supportedArchitectures, cpu, os
...
Cohesion: 0.29
Nodes (6): ADR 0005 — ProtobufCodec stays on `useInputLocalStorage` for its shared bag, code:block1 (top level:), Consequences, Context, Decision, Revisit when
...
Cohesion: 0.5
Nodes (3): EMPTY_DECODED, JwtDecoded, JwtDecoder()
...
Cohesion: 0.33
Nodes (5): ToggleStore, ToggleStoreOptions, UseCommandPaletteStore, UseSidebarStore, UseToast
...
Cohesion: 0.33
Nodes (5): ADR 0007 — Horizontal labeled value cell stays unshelled, Consequences, Context, Decision, Revisit when
...
Cohesion: 0.4
Nodes (4): Direction, EscapeInput, INITIAL_INPUT, MODE_OPTIONS

### Community 372 - "Community 372"
Cohesion: 0.4
Nodes (4): INITIAL_INPUT, SORT_OPTIONS, SortInput, toggleButtonStyles

### Community 373 - "Community 373"
Cohesion: 0.33
Nodes (6): code:ts (await jsonToTypeScript(source, { optionalProperties: optiona), code:ts (await jsonToTypeScript(source, { optionalProperties: optiona), code:ts (onOpen: () => {), code:ts (onOpen: () => {), code:bash (git add src/components/feature/code/JsonToTypeScript.tsx), Task 10: Migrate `JsonToTypeScript` Convert-trigger to `recompute()`

### Community 380 - "Community 380"
Cohesion: 0.5
Nodes (3): DiagramInnerProps, DiagramPanelSwitchProps, DiagramSidePanelProps

### Community 408 - "Community 408"
Cohesion: 0.83
Nodes (3): pxToRem(), remToPx(), solvePxRem()

### Community 487 - "Community 487"
Cohesion: 0.33
Nodes (5): AspectRatioInput, AspectRatioLastEdited, AspectRatioLocked, AspectRatioOutput, AspectRatioSource

### Community 492 - "Community 492"
Cohesion: 0.17
Nodes (9): a, b, c, fn, { result }, { result, rerender }, session, stale (+1 more)

### Community 725 - "Community 725"
Cohesion: 0.2
Nodes (8): CommandPalette(), down, enter, onEnter, { result }, up, useKeyboardListNav(), TimezoneSearchPicker()

### Community 726 - "Community 726"
Cohesion: 0.4
Nodes (5): code:ts (const { error, isPending, result, setInputImmediate } = useT), code:ts (const { error, isPending, recompute, result, setInputImmedia), code:ts (const recompute = () => {), code:bash (git add src/components/common/image-tool/ImageToolShell.tsx), Task 5: ~~Migrate `<ImageToolShell>` to pipeline-owned `recompute`~~ — **SKIPPED**
...
Cohesion: 0.31
Nodes (6): Sidebar(), sidebarNavStyles, SidebarCategory(), SidebarToolItem(), sidebarToolItemVariants, useSidebarStore

### Community 729 - "Community 729"
Cohesion: 0.18
Nodes (15): regenerateDbmlFromDocument(), setDbmlText(), doc, { document, result }, next, withGarbage, withText, documentToSchema() (+7 more)
...
Cohesion: 0.22
Nodes (8): doc, editor, id, listener, next, result, tableId, unsubscribe

### Community 741 - "Community 741"
Cohesion: 0.06
Nodes (25): Editor, EDITOR_OPTIONS, READONLY_EDITOR_OPTIONS, severityStyles, TypescriptPlayground(), UuidGenerator(), d, d1 (+17 more)

### Community 742 - "Community 742"
Cohesion: 0.16
Nodes (5): paletteItemStyles, SearchInput(), defaultDuration, iconVariants, ToastItem()

### Community 743 - "Community 743"
Cohesion: 0.06
Nodes (28): HtmlFormatter(), HtmlInput, INITIAL, CHEATSHEET_ENTRIES, chevronStyles, EvalInput, EvalResult, INITIAL_RESULT (+20 more)

### Community 744 - "Community 744"
Cohesion: 0.5
Nodes (4): code:ts (export type UseToolComputationResult<I, R> = {), code:ts (export type UseToolFieldsResult<F, R> = {), code:ts (export type UseToolComputationPersistedResult<I, R> = {), Task 1: Add `recompute` to the three result types

### Community 745 - "Community 745"
Cohesion: 0.4
Nodes (4): PxRemInput, PxRemLastEdited, PxRemOutput, PxRemSource

### Community 746 - "Community 746"
Cohesion: 0.5
Nodes (4): code:ts (const {), code:ts (return { error, input, isPending, recompute, result, setInpu), code:bash (git add src/hooks/persist/useToolComputationPersisted.ts), Task 4: Pass `recompute` through `useToolComputationPersisted`

### Community 747 - "Community 747"
Cohesion: 0.5
Nodes (4): code:ts (// Unconditional mount-time recompute. Tool has no isEmpty, ), code:ts (// Unconditional mount-time recompute. Tool has no isEmpty, ), code:bash (git add src/components/feature/code/JsonpathEvaluator.tsx), Task 7: Migrate `JsonpathEvaluator` mount-autorun to `recompute()`
...
Cohesion: 0.29
Nodes (5): CommandPalette, SettingsDialog, Sidebar, ToastProvider, TwinkleStarsAnimate

### Community 751 - "Community 751"
Cohesion: 0.5
Nodes (4): code:ts (useMountOnce(() => setFieldsImmediate({}))), code:ts (useMountOnce(() => recompute())), code:bash (git add src/components/feature/color/ColorPaletteGenerator.t), Task 8: Migrate `ColorPaletteGenerator` mount-autorun to `recompute()`

### Community 752 - "Community 752"
Cohesion: 0.5
Nodes (4): code:markdown (The pipeline owns its result, error, and pending state, plus), code:markdown (Also exposes `recompute()` — fire compute with the current b), code:bash (git add CONTEXT.md), Task 11: Document `recompute()` in CONTEXT.md

### Community 753 - "Community 753"
Cohesion: 0.5
Nodes (4): code:tsx (it('recompute: fires compute with the last input passed to s), code:ts (import { useCallback, useEffect, useRef, useState } from 're), code:bash (git add src/types/hooks/computation.ts src/hooks/useToolComp), Task 2: Add `recompute` to `useToolComputation` (TDD)

### Community 754 - "Community 754"
Cohesion: 0.5
Nodes (4): code:tsx (it('recompute: fires compute with the current bag', async ()), code:ts (import { useCallback, useRef, useState } from 'react'), code:bash (git add src/hooks/useToolFields.ts src/hooks/useToolFields.d), Task 3: Add `recompute` to `useToolFields` (TDD)

## Ambiguous Edges - Review These
- `Dashboard layout key migration (legacy → registry keys)` → `Dashboard layout key migration (legacy → registry keys)`  [AMBIGUOUS]
  src/utils/dashboard.ts · relation: implements
- `User-Agent parser (browser/os/engine/device)` → `User-Agent parser (browser/os/engine/device)`  [AMBIGUOUS]
  src/utils/user-agent.ts · relation: implements

## Knowledge Gaps
- **2579 isolated node(s):** `tsBuildInfoFile`, `target`, `lib`, `module`, `skipLibCheck` (+2574 more)
...
- **What is the exact relationship between `Dashboard layout key migration (legacy → registry keys)` and `Dashboard layout key migration (legacy → registry keys)`?**
...
- **What is the exact relationship between `User-Agent parser (browser/os/engine/device)` and `User-Agent parser (browser/os/engine/device)`?**
  _Edge tagged AMBIGUOUS (relation: implements) - confidence is low._
- **Why does `useToolComputation()` connect `Code Tool Family` to `Community 32`, `Community 154`, `Community 743`, `Community 77`, `Community 78`, `Community 240`, `Community 369`, `Community 722`, `Community 723`, `Community 61`, `Community 278`, `Image Tool Shell`, `Community 314`, `Community 315`, `Community 311`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `useDebounceCallback()` connect `Code Tool Family` to `DB Diagram Editor`, `Community 278`, `Community 154`, `Community 309`, `Community 310`, `Community 311`, `Community 314`, `Community 315`, `Community 61`, `Community 77`, `Community 78`, `Community 722`, `Community 723`, `Community 727`, `Community 741`, `Community 743`, `Community 240`, `Community 241`, `Community 369`?**
...
- **Why does `useBlobUrl()` connect `Community 67` to `Community 260`, `Community 102`, `Community 114`, `Community 51`, `Image Tool Shell`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Are the 61 inferred relationships involving `useDebounceCallback()` (e.g. with `TypescriptPlayground()` and `DbmlEditorPanel()`) actually correct?**
  _`useDebounceCallback()` has 61 INFERRED edges - model-reasoned connections that need verification._
- **Are the 55 inferred relationships involving `useToolComputation()` (e.g. with `ImageToolShell()` and `UnitPxToRem()`) actually correct?**
  _`useToolComputation()` has 55 INFERRED edges - model-reasoned connections that need verification._
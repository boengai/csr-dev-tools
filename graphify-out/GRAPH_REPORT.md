...
## Corpus Check
- 641 files · ~258,106 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4303 nodes · 4813 edges · 697 communities (437 shown, 260 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 562 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `51d9240c`
...
## Communities (697 total, 260 thin omitted)
...
Cohesion: 0.11
Nodes (33): GraphqlSchemaViewer(), JavaScriptMinifier(), MarkdownPreview(), ProtobufCodec(), ColorConvertor(), BidirectionalConverter(), EnvFileConverter(), EscapedJsonStringifier() (+25 more)
...
Cohesion: 0.08
Nodes (18): useToolFields(), IpSubnetCalculator(), AesEncryptDecrypt(), AesInput, INITIAL_INPUT, Mode, RegexTester(), Direction (+10 more)
...
Cohesion: 0.11
Nodes (15): dialog, editors, output, trigger, decimalInput, dialog, hexInput, output (+7 more)
...
Cohesion: 0.12
Nodes (13): firstSwatch, hexInput, picker, swatches, bgPicker, downloadPromise, heightInput, preview (+5 more)
...
Cohesion: 0.2
Nodes (9): code:bash (git add src/components/feature/code/MermaidRenderer.tsx), Phase 3 — Pattern-B tools, Playwright MCP verification protocol, Self-review, Spec reference, Task 16: MermaidRenderer migration, Task 17: Remaining Pattern-B tools (one task per tool), Tool Dialog Shell — Implementation Plan (+1 more)
...
Cohesion: 0.25
Nodes (7): Bidirectional converter, CSR Dev Tools — Domain Language, DiagramEditor, Image tool shell, Tool, Tool computation pipeline, Tool field bag
...
Cohesion: 0.5
Nodes (3): checkboxes, octalInput, symbolicInput
...
Cohesion: 0.67
Nodes (3): code:tsx (<ToolDialogShell), code:bash (git add <path>), Task 15: QrCodeGenerator migration

### Community 388 - "Community 388"
Cohesion: 0.67
Nodes (3): code:tsx (<ToolDialogShell), code:bash (git add src/components/feature/security/AesEncryptDecrypt.ts), Task 14: AesEncryptDecrypt migration
...
## Knowledge Gaps
- **2130 isolated node(s):** `toolRoutes`, `PreRenderRoute`, `dialog`, `input`, `editors` (+2125 more)
...
- **What is the exact relationship between `User-Agent parser (browser/os/engine/device)` and `User-Agent parser (browser/os/engine/device)`?**
  _Edge tagged AMBIGUOUS (relation: implements) - confidence is low._
- **Why does `useToolComputation()` connect `Community 11` to `Community 130`, `Community 18`, `Community 25`, `Community 156`, `Community 29`, `Community 295`, `Community 296`, `Community 297`, `Community 299`, `Community 300`, `Community 47`, `Community 60`, `Community 71`, `Community 72`, `Community 87`, `Community 216`, `Community 111`, `Community 376`, `Community 377`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `ImageToolShell()` connect `Community 25` to `Community 11`, `Community 68`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `useBlobUrl()` connect `Community 68` to `Community 54`, `Community 25`, `Community 380`, `Community 302`?**

...
## Corpus Check
- 633 files · ~253,951 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4317 nodes · 4830 edges · 700 communities (443 shown, 257 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 562 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6be17316`
...
## Communities (700 total, 257 thin omitted)
...
Cohesion: 0.1
Nodes (23): heightInput, ratioInput, widthInput, hashOutput, checkboxes, octalInput, symbolicInput, hexInput (+15 more)
...
Cohesion: 0.08
Nodes (23): dialog, editors, output, trigger, dialog, output, dialog, input (+15 more)

### Community 22 - "Community 22"
Cohesion: 0.11
Nodes (22): isValidDocument(), cloneDocument(), createInitialDocument(), a, b, doc, seed(), importFromJsonSchema() (+14 more)
...
Cohesion: 0.21
Nodes (7): CloseButton(), DIALECT_OPTIONS, diagramItemStyles, DiagramListPanel(), ExportMermaidPanel(), ExportSqlPanel(), ImportSqlPanel()
...
Cohesion: 0.16
Nodes (13): COLUMN_TYPES, createDefaultColumn(), createDefaultTable(), col, col1, col2, id, id1 (+5 more)
...
Cohesion: 0.22
Nodes (8): Bidirectional converter, CSR Dev Tools — Domain Language, DiagramEditor, Image tool shell, Tool, Tool computation pipeline, Tool dialog frame, Tool field bag
...
## Knowledge Gaps
- **2139 isolated node(s):** `toolRoutes`, `PreRenderRoute`, `dialog`, `input`, `editors` (+2134 more)
...
- **What is the exact relationship between `User-Agent parser (browser/os/engine/device)` and `User-Agent parser (browser/os/engine/device)`?**
  _Edge tagged AMBIGUOUS (relation: implements) - confidence is low._
- **Why does `useToolComputation()` connect `Community 5` to `Community 134`, `Community 24`, `Community 157`, `Community 163`, `Community 41`, `Community 302`, `Community 47`, `Community 304`, `Community 305`, `Community 306`, `Community 309`, `Community 58`, `Community 69`, `Community 72`, `Community 73`, `Community 88`, `Community 222`, `Community 116`, `Community 382`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `useBlobUrl()` connect `Community 70` to `Community 24`, `Community 385`, `Community 53`, `Community 310`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `ImageToolShell()` connect `Community 24` to `Community 5`, `Community 70`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._

...
## Corpus Check
- 625 files · ~255,052 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4145 nodes · 4568 edges · 689 communities (423 shown, 266 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 520 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b1b5e446`
...
## Communities (689 total, 266 thin omitted)
...
Cohesion: 0.13
Nodes (32): GraphqlSchemaViewer(), HtmlFormatter(), JavaScriptMinifier(), JsonSchemaValidator(), JsonToTypeScript(), MarkdownPreview(), DecodeContent(), EncodeContent() (+24 more)
...
Cohesion: 0.13
Nodes (15): isValidDocument(), Listener, documentToFlow(), doc, docWithOneTable(), { edges }, { nodes }, { nodes, edges } (+7 more)
...
Cohesion: 0.11
Nodes (17): detailPanel, editor, roleRef, cmContent, copyButtons, editor, expressionInput, resultsPanel (+9 more)
...
Cohesion: 0.1
Nodes (7): DataUriGenerator(), initialState, Base64ToImage(), ImageToBase64(), FILE_EXTENSIONS, formatFileSize(), formatBase64Size()
...
Cohesion: 0.17
Nodes (11): code:tsx (const handleReset = () => {), code:bash (git add src/components/feature/image/BackgroundRemover/index), code:block26 (pnpm tsc --noEmit), code:block27 (git diff --stat main..HEAD -- 'src/components/feature/**/*.t), code:block28 (graphify update .), Phase 4 — Conditional-reset edge cases, Phase 5 — Cleanup, Self-review (+3 more)
...
Cohesion: 0.2
Nodes (9): code:bash (git commit --allow-empty -m "chore: verify Phase 2 WASM buil), code:bash (git add package.json pnpm-lock.yaml), File Structure, Modified files, New files, Phase 2 — WASM Crypto Migration Implementation Plan, Task 11: Remove bcryptjs dependency, Task 13: Final verification (+1 more)
...
Cohesion: 0.5
Nodes (4): Playwright MCP verification protocol, Spec reference, Tool Dialog Shell — Implementation Plan, Tool inventory (from `TOOL_ROUTES`)
...
## Knowledge Gaps
- **2030 isolated node(s):** `toolRoutes`, `PreRenderRoute`, `dialog`, `input`, `editors` (+2025 more)
...
- **What is the exact relationship between `User-Agent parser (browser/os/engine/device)` and `User-Agent parser (browser/os/engine/device)`?**
  _Edge tagged AMBIGUOUS (relation: implements) - confidence is low._
- **Why does `useDebounceCallback()` connect `Community 12` to `Community 1`, `Community 131`, `Community 23`, `Community 156`, `Community 286`, `Community 287`, `Community 288`, `Community 289`, `Community 291`, `Community 36`, `Community 292`, `Community 180`, `Community 208`, `Community 209`, `Community 210`, `Community 211`, `Community 83`, `Community 475`, `Community 92`, `Community 476`, `Community 477`, `Community 479`, `Community 109`, `Community 368`, `Community 370`, `Community 371`, `Community 244`, `Community 245`, `Community 373`, `Community 374`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `useToolComputation()` connect `Community 12` to `Community 128`, `Community 289`, `Community 292`, `Community 36`, `Community 76`, `Community 109`, `Community 370`, `Community 210`, `Community 83`, `Community 156`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `cnMerge()` connect `Community 84` to `Community 1`, `Community 156`, `Community 110`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._

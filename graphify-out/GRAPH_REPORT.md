...
## Corpus Check
- 644 files · ~258,721 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4317 nodes · 4830 edges · 695 communities (440 shown, 255 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 562 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6b2ff8bc`
...
## Communities (695 total, 255 thin omitted)
...
Cohesion: 0.1
Nodes (32): GraphqlSchemaViewer(), JavaScriptMinifier(), MarkdownPreview(), ProtobufCodec(), ColorConvertor(), BidirectionalConverter(), EnvFileConverter(), EscapedJsonStringifier() (+24 more)
...
Cohesion: 0.07
Nodes (19): useToolFields(), IpSubnetCalculator(), DEFAULT_FLAGS, INITIAL_COMPUTED, INITIAL_INPUT, RegexComputed, RegexInput, RegexTester() (+11 more)

### Community 23 - "Community 23"
Cohesion: 0.09
Nodes (21): isValidDocument(), doc, editor, id, listener, next, result, tableId (+13 more)
...
Cohesion: 0.08
Nodes (15): compute, errorSpy, onError, resolvers, { result }, { result, unmount }, compute, INITIAL (+7 more)
...
Cohesion: 0.15
Nodes (12): hashOutput, checkboxes, octalInput, symbolicInput, button2048, generateButton, privateKeyCm, publicKeyCm (+4 more)
...
- **What is the exact relationship between `User-Agent parser (browser/os/engine/device)` and `User-Agent parser (browser/os/engine/device)`?**
  _Edge tagged AMBIGUOUS (relation: implements) - confidence is low._
- **Why does `useToolComputation()` connect `Community 10` to `Community 17`, `Community 150`, `Community 279`, `Community 280`, `Community 25`, `Community 22`, `Community 283`, `Community 285`, `Community 286`, `Community 32`, `Community 46`, `Community 70`, `Community 71`, `Community 206`, `Community 208`, `Community 86`, `Community 351`, `Community 108`, `Community 125`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `useBlobUrl()` connect `Community 68` to `Community 54`, `Community 25`, `Community 382`, `Community 305`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `ImageToolShell()` connect `Community 25` to `Community 10`, `Community 68`?**

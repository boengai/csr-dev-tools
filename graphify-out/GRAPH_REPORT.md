...
## Corpus Check
- 638 files · ~254,930 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4340 nodes · 4861 edges · 701 communities (447 shown, 254 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 564 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c40dbd06`
...
## Communities (701 total, 254 thin omitted)
...
Cohesion: 0.08
Nodes (35): CssFormatter(), CssInput, JavaScriptMinifier(), MarkdownPreview(), ColorConvertor(), BidirectionalConverter(), EnvFileConverter(), EscapedJsonStringifier() (+27 more)
...
Cohesion: 0.14
Nodes (14): hashOutput, detailPanel, editor, roleRef, editor, outputPanel, preElement, button2048 (+6 more)
...
Cohesion: 0.24
Nodes (5): Base64Mode, EncodingBase64(), MODES, CASES, TextCaseConverter()
...
## Knowledge Gaps
- **2150 isolated node(s):** `toolRoutes`, `PreRenderRoute`, `dialog`, `input`, `editors` (+2145 more)
...
- **What is the exact relationship between `User-Agent parser (browser/os/engine/device)` and `User-Agent parser (browser/os/engine/device)`?**
  _Edge tagged AMBIGUOUS (relation: implements) - confidence is low._
- **Why does `useToolComputation()` connect `Community 3` to `Community 134`, `Community 265`, `Community 24`, `Community 25`, `Community 163`, `Community 164`, `Community 42`, `Community 308`, `Community 309`, `Community 310`, `Community 312`, `Community 313`, `Community 64`, `Community 192`, `Community 67`, `Community 86`, `Community 229`, `Community 230`, `Community 113`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `ImageToolShell()` connect `Community 25` to `Community 3`, `Community 76`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `useBlobUrl()` connect `Community 76` to `Community 25`, `Community 52`, `Community 135`?**

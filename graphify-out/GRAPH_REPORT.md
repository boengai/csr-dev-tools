...
## Corpus Check
- 629 files · ~254,937 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4198 nodes · 4634 edges · 698 communities (429 shown, 269 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 536 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `893fc59f`
...
## Communities (698 total, 269 thin omitted)
...
Cohesion: 0.15
Nodes (31): GraphqlSchemaViewer(), HtmlFormatter(), JavaScriptMinifier(), JsonSchemaValidator(), JsonToTypeScript(), MarkdownPreview(), ProtobufCodec(), ColorConvertor() (+23 more)
...
Cohesion: 0.11
Nodes (22): isValidDocument(), Listener, cloneDocument(), createInitialDocument(), a, b, doc, importFromJsonSchema() (+14 more)
...
Cohesion: 0.1
Nodes (19): hashOutput, detailPanel, editor, roleRef, cmContent, copyButtons, editor, expressionInput (+11 more)
...
Cohesion: 0.1
Nodes (19): dialog, output, dialog, input, secretInput, textInput, decimalInput, dialog (+11 more)
...
Cohesion: 0.14
Nodes (11): aspectButtonStyles, cropAreaStyles, CropControls, CropPreview(), CropPreviewProps, ImageCropper(), initialState, TABS_VALUES (+3 more)
...
Cohesion: 0.18
Nodes (12): DbmlEditorPanel(), DiagramCanvas(), edgeTypes, nodeTypes, ContextValue, Ctx, DiagramProvider(), useDiagram() (+4 more)
...
Cohesion: 0.14
Nodes (13): code:block1 (wasm/), code:block2 (src/wasm/), code:toml ([package]), code:rust (use wasm_bindgen::prelude::*;), code:bash (cd wasm && cargo test -p csr-uuid), code:bash (git add wasm/crates/csr-uuid/), code:block3 (vite.config.ts                          # Add WASM plugins), File Structure (+5 more)
...
Cohesion: 0.15
Nodes (10): dialog, editors, output, trigger, dialog, output, dialog, output (+2 more)

### Community 73 - "Community 73"
Cohesion: 0.15
Nodes (10): checkboxes, octalInput, symbolicInput, firstSwatch, hexInput, picker, swatches, dialog (+2 more)
...
Cohesion: 0.21
Nodes (9): KindBadge(), ConstraintToggle(), SelectInput(), TextAreaInput(), inputVariants, TextInput(), cnMerge(), tv (+1 more)
...
Cohesion: 0.23
Nodes (11): applyDbmlNow(), DBML_TYPE_MAP, DBML_TYPE_REVERSE, formatConstraints(), generateDbml(), parseColumnLine(), parseConstraintBrackets(), parseDbml() (+3 more)

### Community 86 - "Community 86"
Cohesion: 0.24
Nodes (6): CloseButton(), diagramItemStyles, DiagramListPanel(), ExportMermaidPanel(), ExportTypescriptPanel(), ImportJsonSchemaPanel()
...
Cohesion: 0.33
Nodes (5): Bidirectional converter, CSR Dev Tools — Domain Language, Image tool shell, Tool, Tool computation pipeline
...
Cohesion: 0.4
Nodes (4): dialog, editors, input, jwtData
...
## Knowledge Gaps
- **2064 isolated node(s):** `toolRoutes`, `PreRenderRoute`, `dialog`, `input`, `editors` (+2059 more)
...
- **What is the exact relationship between `User-Agent parser (browser/os/engine/device)` and `User-Agent parser (browser/os/engine/device)`?**
  _Edge tagged AMBIGUOUS (relation: implements) - confidence is low._
- **Why does `useDebounceCallback()` connect `Community 13` to `Community 129`, `Community 271`, `Community 272`, `Community 273`, `Community 275`, `Community 277`, `Community 278`, `Community 22`, `Community 153`, `Community 28`, `Community 169`, `Community 430`, `Community 431`, `Community 432`, `Community 433`, `Community 46`, `Community 56`, `Community 66`, `Community 197`, `Community 198`, `Community 199`, `Community 200`, `Community 91`, `Community 348`, `Community 349`, `Community 347`, `Community 351`, `Community 352`, `Community 102`, `Community 236`, `Community 237`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `useToolComputation()` connect `Community 13` to `Community 66`, `Community 102`, `Community 200`, `Community 74`, `Community 271`, `Community 277`, `Community 22`, `Community 24`, `Community 153`, `Community 122`, `Community 347`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `ImageToolShell()` connect `Community 24` to `Community 64`, `Community 13`?**
...
- **Are the 37 inferred relationships involving `useToolComputation()` (e.g. with `BidirectionalConverter()` and `ImageToolShell()`) actually correct?**
  _`useToolComputation()` has 37 INFERRED edges - model-reasoned connections that need verification._
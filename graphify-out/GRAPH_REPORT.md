...
## Corpus Check
- 627 files · ~255,087 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4153 nodes · 4587 edges · 692 communities (428 shown, 264 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 531 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cf8f3bf0`
...
2. `useToolComputation()` - 38 edges
3. `DiagramEditor` - 30 edges
4. `utils barrel index` - 24 edges
5. `createInitialDocument()` - 21 edges
6. `useInputLocalStorage()` - 20 edges
7. `File Structure` - 17 edges
8. `icon barrel export` - 16 edges
9. `useStaleSafeAsync()` - 15 edges
10. `CSR Developer Tools - Development Guide` - 15 edges
...
## Communities (692 total, 264 thin omitted)
...
Cohesion: 0.05
Nodes (28): BackgroundRemoverError(), BackgroundRemover(), initialState, reducer(), TABS_VALUES, BackgroundRemoverProcessing(), BackgroundRemoverResult(), a (+20 more)
...
Cohesion: 0.13
Nodes (32): CssFormatter(), GraphqlSchemaViewer(), JavaScriptMinifier(), MarkdownPreview(), DecodeContent(), EncodeContent(), SqlFormatter(), ColorConvertor() (+24 more)
...
Cohesion: 0.1
Nodes (21): hashOutput, checkboxes, octalInput, symbolicInput, firstSwatch, hexInput, picker, swatches (+13 more)
...
Cohesion: 0.1
Nodes (18): dialog, output, decimalInput, dialog, hexInput, output, input, output (+10 more)
...
Cohesion: 0.11
Nodes (17): buildPreviewUri(), initialState, PlaceholderImageGenerator(), PRESET_OPTIONS, reducer(), toPickerHex(), blob, clickSpy (+9 more)
...
Cohesion: 0.13
Nodes (16): isValidDocument(), Listener, doc, editor, id, listener, next, result (+8 more)
...
Cohesion: 0.12
Nodes (10): HtmlFormatter(), HtmlInput, JsonSchemaValidator(), JsonToTypeScript(), JsonTsInput, fn, fn1, fn2 (+2 more)
...
Cohesion: 0.15
Nodes (6): initialState, TABS_VALUES, ImagePreview(), ResizeInput, TABS_VALUES, ImageResizerControls()
...
Cohesion: 0.21
Nodes (9): dialog, output, dialog, output, codeInputIn, commandPalette, sidebar, sections (+1 more)
...
Cohesion: 0.14
Nodes (13): code:block1 (wasm/), code:block2 (src/wasm/), code:block3 (vite.config.ts                          # Add WASM plugins), code:ts (import { bench, describe } from 'vitest'), code:json ({), code:bash (pnpm bench -- benchmarks/phase1.bench.ts), code:bash (git add benchmarks/phase1.bench.ts package.json), File Structure (+5 more)
...
Cohesion: 0.22
Nodes (12): applyDbmlNow(), DBML_TYPE_MAP, DBML_TYPE_REVERSE, formatConstraints(), generateDbml(), parseColumnLine(), parseConstraintBrackets(), parseDbml() (+4 more)
...
Cohesion: 0.19
Nodes (10): BidirectionalConverter(), compute, Mode, MODES, onAfterDialogClose, onError, slot, readSource() (+2 more)

### Community 77 - "Community 77"
Cohesion: 0.18
Nodes (10): Action, ContentProps, DecodeInput, EncodeInput, FORMAT_OPTIONS, INITIAL_STATE, PersistedState, ProtobufCodec() (+2 more)
...
Cohesion: 0.23
Nodes (8): KindBadge(), SelectInput(), TextAreaInput(), inputVariants, TextInput(), cnMerge(), tv, twMergeConfig
...
Cohesion: 0.17
Nodes (4): DataUriGenerator(), initialState, FILE_EXTENSIONS, formatFileSize()
...
Cohesion: 0.18
Nodes (8): detailPanel, editor, roleRef, cmContent, copyButtons, editor, expressionInput, resultsPanel
...
Cohesion: 0.25
Nodes (7): Behavior Contract, Behavior Contract, Behavior Contract, Task 1: csr-csv — CSV Parse/Stringify WASM Crate, Task 2: csr-diff — Myers Diff Algorithm WASM Crate, Task 3: csr-color — 6 Color Space Conversion WASM Crate, WASM Phase 3 — Text Processing Implementation Plan
...
Cohesion: 0.29
Nodes (7): code:ts (// src/diagram/state.spec.ts), code:ts (// src/diagram/state.ts), code:bash (git add -A), code:bash (git add src/diagram/state.ts src/diagram/state.spec.ts), Phase 1 — Build the editor (no UI change), Task 12: Verify the editor module compiles and full test suite passes, Task 2: Initial document factory + clone
...
Cohesion: 0.4
Nodes (4): Bidirectional converter, CSR Dev Tools — Domain Language, Tool, Tool computation pipeline
...
Cohesion: 0.67
Nodes (3): code:bash (git add package.json pnpm-lock.yaml), Steps, Task 4: Integration — Build, Full Test Suite, Remove `diff` Dependency
...
## Knowledge Gaps
- **2034 isolated node(s):** `toolRoutes`, `PreRenderRoute`, `dialog`, `input`, `editors` (+2029 more)
...
- **What is the exact relationship between `User-Agent parser (browser/os/engine/device)` and `User-Agent parser (browser/os/engine/device)`?**
  _Edge tagged AMBIGUOUS (relation: implements) - confidence is low._
- **Why does `useDebounceCallback()` connect `Community 13` to `Community 1`, `Community 24`, `Community 152`, `Community 290`, `Community 292`, `Community 293`, `Community 294`, `Community 46`, `Community 177`, `Community 77`, `Community 81`, `Community 82`, `Community 211`, `Community 212`, `Community 213`, `Community 210`, `Community 88`, `Community 477`, `Community 479`, `Community 480`, `Community 482`, `Community 107`, `Community 369`, `Community 370`, `Community 373`, `Community 246`, `Community 247`, `Community 374`, `Community 126`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `useToolComputation()` connect `Community 13` to `Community 107`, `Community 76`, `Community 77`, `Community 46`, `Community 81`, `Community 210`, `Community 152`, `Community 125`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `cnMerge()` connect `Community 80` to `Community 152`, `Community 1`, `Community 106`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
...
- **Are the 36 inferred relationships involving `useToolComputation()` (e.g. with `BidirectionalConverter()` and `CertificateDecoder()`) actually correct?**
  _`useToolComputation()` has 36 INFERRED edges - model-reasoned connections that need verification._
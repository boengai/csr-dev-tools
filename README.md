...
- **[Monaco Editor](https://microsoft.github.io/monaco-editor/)** — VS Code editor component (TypeScript Playground)
- **[React Flow](https://reactflow.dev/)** — Interactive node-based diagrams (DB Diagram)
